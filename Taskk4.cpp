...
public:
	...
	void introduce_pet()
	{
		cout << "He has a dog named " << pet.name << ". He is a " << pet.breed << " and is " << pet.age << " years old." << endl;
		pet.bark();
	}

	void introduce_person()
	{
		cout << "This is " << name << ". He is " << age << " years old." << endl;
	}
...
int main()
{
	...
	house1.person1.changePet("Swift", "Doberman", 5);
	...
	house2.person2.changePet("Cupcake", "Attack Helicopter", 10);
